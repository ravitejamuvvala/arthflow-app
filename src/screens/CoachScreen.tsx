    ...
    const chatContext = {
      ...
      engine: engineResult ? {
        ...
        budget: engineResult.budget ? {
          label: engineResult.budget.label,
          needsTarget: engineResult.budget.needsTarget,
          wantsTarget: engineResult.budget.wantsTarget,
          savingsTarget: engineResult.budget.savingsTarget,
          rationale: engineResult.budget.rationale,
          strategy: engineResult.budget.strategy,
          verdict: engineResult.budget.verdict,
          goalSipNeeded: engineResult.budget.goalSipNeeded,
          goalSipGap: engineResult.budget.goalSipGap,
          compliance: engineResult.budget.compliance,
        } : undefined,
        goalHorizonPlan: engineResult.goalHorizonPlan ? {
          totalSipNeeded: engineResult.goalHorizonPlan.totalSipNeeded,
          totalSipRaw: engineResult.goalHorizonPlan.totalSipRaw,
          sipCapped: engineResult.goalHorizonPlan.sipCapped,
          liquidUsed: engineResult.goalHorizonPlan.liquidUsed,
          excessLiquid: engineResult.goalHorizonPlan.excessLiquid,
          stretchGoals: engineResult.goalHorizonPlan.stretchGoals,
        } : undefined,
        liquidFundAnalysis: engineResult.liquidFundAnalysis,
      } : undefined,
    }
